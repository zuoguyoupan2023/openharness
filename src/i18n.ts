...
const DICT: Record<string, Entry> = {
  ...
  "plugins.localInstall": { zh: "安装本地插件", en: "Install local plugin" },
  "plugins.localPathPlaceholder": { zh: "本地路径：plugins/我的插件 或 /abs/plugin.tgz（支持 .tgz 或目录）", en: "Local path: ./my-plugin  or  /abs/plugin.tgz (folder or .tgz)" },
