...
const DICT: Record<string, Entry> = {
  ...
  "link.deepseek": { zh: "DeepSeek 官网", en: "DeepSeek official site" },
  "link.chat": { zh: "DeepSeek 官方对话", en: "DeepSeek Chat" },
  "link.npm": { zh: "npm 官网", en: "npm" },
  "link.github": { zh: "GitHub", en: "GitHub" },
  "link.repo": { zh: "DeepSeek-Harness 仓库", en: "DeepSeek-Harness repo" },
  "link.openharness": { zh: "OpenHarness 仓库", en: "OpenHarness repo" },
  ...
  "plugins.detail.readmeExpand": { zh: "展开全文", en: "Expand" },
  "plugins.detail.readmeCollapse": { zh: "收起", en: "Collapse" },
  "plugins.detail.links": { zh: "相关链接", en: "Links" },
  "plugins.detail.npmPage": { zh: "npm 包页", en: "npm page" },
  "plugins.detail.repository": { zh: "代码仓库", en: "Repository" },
  "plugins.detail.releases": { zh: "Releases / Changelog", en: "Releases / Changelog" },
  ...
  "plugins.pin": { zh: "收藏置顶", en: "Pin to top" },
  "plugins.unpin": { zh: "取消置顶", en: "Unpin" },
  "plugins.pinnedTag": { zh: "已置顶", en: "Pinned" },
  ...
  // ===== P2 ⌘K 命令面板（013 §P2） =====
  "cmdPalette.placeholder": { zh: "搜索插件 / npm 包 / 路径 / 动作…", en: "Search plugins / npm / path / actions…" },
  "cmdPalette.hint": { zh: "↑↓ 选择 · Enter 执行 · Esc 关闭", en: "↑↓ navigate · Enter run · Esc close" },
  ...
  "cmdPalette.gotoOfficial": { zh: "直达官方组合包", en: "Go to official bundles" },
  "cmdPalette.refreshDesc": { zh: "刷新插件索引（后台 diff 更新）", en: "Refresh plugin index (background diff)" },
  "cmdPalette.updateAllDesc": { zh: "一键更新全部可更新插件", en: "Update all updatable plugins" },
  "cmdPalette.installPath": { zh: "从该路径安装插件", en: "Install plugin from this path" },
  "cmdPalette.noResult": { zh: "无匹配结果", en: "No results" },
  "cmdPalette.npmSearching": { zh: "正在搜索 npm …", en: "Searching npm…" },
  ...
  "settings.version.desc": {
    ...
    en: "Auto: DSH always uses the latest stable version on startup. Manual: DSH stays on the current version until you click “Update to latest” (applies after a DSH restart).",
  },
  "settings.version.auto": { zh: "自动更新（推荐）：启动 DSH 时自动使用最新稳定版", en: "Auto-update (recommended): use the latest stable DSH on startup" },
  "settings.version.manual": { zh: "手动更新：固定当前版本，点「更新到最新版」才升级", en: "Manual updates: stay on the current version until you update" },
  ...
  "settings.version.updateNow": { zh: "更新到最新版", en: "Update to latest" },
  ...
  "settings.version.modeAutoSaved": { zh: "✓ 已切换到自动更新（跟随最新，重启 DSH 后生效）", en: "Auto-update enabled (follows latest; applies after restart)" },
